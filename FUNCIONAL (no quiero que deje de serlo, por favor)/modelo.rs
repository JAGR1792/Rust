...
pub const COLOR_FONDO: graphics::Color = graphics::Color::new(0.5, 0.7, 0.9, 1.0);

pub const POSICION_SEMAFORO_VERTICAL: f32 = 235.0; // entre Menor sea este número, mas a la izquierda se detendrá el vehiculo, pues afecta a la linea oeste-este
pub const POSICION_SEMAFORO_HORIZONTAL: f32 = 373.0; // Entre mayor sea este número, más abajo se detendrá este vehículo pues afecta a la linea sur-norte
...
pub const FPS_SIMULACION: u64 = 60;
